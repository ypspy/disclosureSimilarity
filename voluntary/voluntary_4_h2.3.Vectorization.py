...
with open("voluntary_4_h2.tfIdfVec_twitter_noun_trigram.pkl", 'wb') as output:
...
with open('voluntary_4_ngram_counter.csv','w') as f:
    w = csv.writer(f)
    w.writerow(ngram_counter.keys())
    w.writerow(ngram_counter.values())
